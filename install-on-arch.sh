...
sudo pacman -S --noconfirm --needed rofi nitrogen xorg xorg-xinit xorg-xinput $DRI xmonad # feh
...
[yY][eE][sS]|[yY])
	...
	$HELPER -S picom-jonaburg-git acpi candy-icons-git wmctrl kitty playerctl dunst xmonad-contrib jq xclip maim rofi-greenclip
	;;
